...
(define *ballBody2
  (cpSpaceAddBody *space (cpBodyNew mass moment)))
(cpBodySetPosition *ballBody (cpv 60.0 15.0))
(cpBodySetPosition *ballBody1 (cpv 66.0 15.0))
(cpBodySetPosition *ballBody2 (cpv 54.0 15.0))

; Now we create the collision shape for the ball.
; You can create multiple collision shapes that point to the same body.
; They will all be attached to the body and move around to follow it.
(define *ballShape
  (cpSpaceAddShape *space (cpCircleShapeNew *ballBody radius (cpv 0.0 0.0))))
(cpShapeSetFriction *ballShape 0.7)
(define *ballShape1
  (cpSpaceAddShape *space (cpCircleShapeNew *ballBody1 radius (cpv 0.0 0.0))))
(cpShapeSetFriction *ballShape1 0.7)
(define *ballShape2
  (cpSpaceAddShape *space (cpCircleShapeNew *ballBody2 radius (cpv 0.0 0.0))))
